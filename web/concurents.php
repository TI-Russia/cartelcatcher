...
select ".$top."B.*,contractslt.contractnumber,contractslt.price,orgs.gid,orgs.inn,orgs.name,o2.inn,o2.name from (
	...
	(
		...
		from DoubleConcurents inner join purchasesLT on purchasesLT.purchasenumber=DoubleConcurents.purchasenumber 
 ...
 left join contractsLT on (B.oid=contractslt.oid and B.purchasenumber=contractslt.purchasenumber and B.lot=contractslt.lot) 
