...
//define globals
 ...
 $inputstyle='style="color:#000000; background-color:#ffffff; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px;">';
 $submitstyle='style="color:#000000; font-size:20px; background-color:#f8a117; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px;">';
 $xlshdr='
